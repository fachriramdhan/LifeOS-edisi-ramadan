...
const Layout = () => {
  ...
  const { settings, toggleSetting, requestPermission, permissionGranted } =
    useNotifications();
          ...
          {isMenuOpen && (
            ...
            >
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-2xl font-bold font-display dark:text-white">
                  Menu
                </h2>
                <button
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center mb-4">
                    ...
                    {!permissionGranted && (
                      <button
                        ...
                        className="text-xs bg-black dark:bg-white text-white dark:text-black px-3 py-1 rounded-full font-bold"
                      >
                        Aktifkan
                      </button>
                    )}
                ...
                <NavLink
                  to="/reports"
                  onClick={() => setIsMenuOpen(false)}
                  className="block p-4 bg-gray-50 dark:bg-gray-900 rounded-2xl font-medium dark:text-white"
                >
                  Laporan Bulanan
                </NavLink>
                ...
                <button
                  onClick={logout}
                  className="w-full p-4 bg-red-50 dark:bg-red-900/20 text-red-600 rounded-2xl font-medium text-left"
                >
                  Keluar
                </button>
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-emerald-50 dark:bg-emerald-900/20 p-6 rounded-3xl border border-emerald-100 dark:border-emerald-800">
                  <h3 className="font-bold text-lg mb-2 dark:text-white">
                    Selamat Datang di MyLifeOS! 🌙
                  </h3>
                  <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                    Aplikasi ini dirancang untuk membantu kamu menjalani Ramadan
                    yang lebih produktif dan bermakna. Berikut adalah panduan
                    singkat penggunaan fitur-fiturnya.
                  </p>
                </div>
                ...
                <div className="text-center pt-8 pb-4">
                  <p className="text-xs text-gray-400">
                    Dibuat dengan ❤️ untuk Ramadan yang lebih baik.
                  </p>
                </div>
              </div>
            </motion.div>
